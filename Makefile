...
.PHONY: remove-e2e-logs
remove-e2e-logs: ## Remove logs directories generated by E2E tests.
	find tests/e2e/tests -type d \( -name logs -o -name test-artifacts \) -prune -exec rm -rf {} +
