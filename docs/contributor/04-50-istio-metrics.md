...
| **istio_forward_client_cert_details_configured**     | Indicates whether **forwardClientCertDetails** is different from the default value of `SANITIZE_SET` (`1` for configured, `0` for not configured). |
