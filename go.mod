...
require (
	...
	istio.io/istio v0.0.0-20260306174214-6991a379e1fc
	k8s.io/api v0.35.3
	...
	sigs.k8s.io/controller-runtime v0.23.3 // Since we are using the Istio library directly, we should also use the controller-runtime version that is used by Istio.
...
require (
	...
	github.com/envoyproxy/go-control-plane/contrib v1.36.1-0.20260108162445-88062bc404b3 // indirect
	github.com/envoyproxy/go-control-plane/envoy v1.36.1-0.20260108162445-88062bc404b3 // indirect
