...
//nolint:funlen // this function has too many statements (52). TODO refactor this function
func installIstio(ctx context.Context, args installArgs) (istiooperator.IstioImageVersion, describederrors.DescribedError) {
	...
	if _, ok := istioCR.Annotations[labels.LastAppliedConfiguration]; ok {
		...
		err = configuration.CheckIstioVersionUpdate(lastAppliedConfig.IstioTag, istioImageVersion.Tag())
		if err != nil {
