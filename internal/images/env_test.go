...
var _ = Describe("Images.GetImageRegistryAndTag", func() {
	...
	DescribeTable("GetImageRegistryAndTag",
		...
		Entry("invalid image hub",
			...
			true,
			fmt.Errorf("image pilot:1.10.0 does not contain a valid format"),
		),
		...
		Entry("images with digest suffix",
			fields{
				...
				InstallCNI: "docker.io/istio/cni:1.10.0@sha256:90638cf608f9c5dc4b67062a4ssdassa23a21199d6b6214b7703822e04d33910",
		...
		Entry("registry with port",
			fields{
				...
				InstallCNI: "localhost:5000/istio/cni:1.10.0",
				ProxyV2:    "localhost:5000/istio/proxyv2:1.10.0",
				Ztunnel:    "localhost:5000/istio/ztunnel:1.10.0",
			},
			images.RegistryAndTag{Registry: "localhost:5000/istio", Tag: "1.10.0"},
			false,
			nil,
		),
		Entry("registry with port images with digest suffix",
			fields{
				...
				InstallCNI: "docker.io:9000/istio/cni:1.10.0@sha256:90638cf608f9c5dc4b67062a44dc60fa23a21199d6b6214b7703822e04d33910",
			...
			images.RegistryAndTag{Registry: "docker.io:9000/istio", Tag: "1.10.0"},
			false,
			nil,
		),
	)
