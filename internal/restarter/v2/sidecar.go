...
// SidecarImageChanged is a Rule that detects Istio proxy sidecar image drift.
...
// NewSidecarImageChangedRule returns a Rule that restarts workloads whose sidecar
// image differs from the expected one.
func NewSidecarImageChangedRule(image images.Image) Rule {
	return &SidecarImageChanged{expectedImage: image}
}

// SidecarResourcesChanged is a Rule that detects Istio proxy sidecar resource drift.
...
// NewSidecarResourcesChangedRule returns a Rule that restarts workloads whose
// sidecar resources differ from the given requirements.
func NewSidecarResourcesChangedRule(reqs corev1.ResourceRequirements) Rule {
