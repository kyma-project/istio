...
1. To regenerate a corrupted certificate, follow [this tutorial](https://kyma-project.io/docs/kyma/latest/03-tutorials/00-security/sec-01-tls-certificates-security/). If you are running Kyma provisioned through Gardener, follow this [troubleshooting guide](../security/sec-01-certificates-gardener.md) instead. //TODO sprawdzic czy mozna linkowac do kymy
