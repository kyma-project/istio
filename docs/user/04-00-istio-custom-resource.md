...
| **enableDNSProxying** <br /> boolean | Enables or disables cluster-wide DNS proxying in Istio sidecar and gateway proxies.<br />When enabled, DNS requests from application pods are intercepted by the Istio proxies<br />instead of being sent directly to upstream DNS servers. | Optional <br /> |
