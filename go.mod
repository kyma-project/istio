...
require (
	...
	istio.io/istio v0.0.0-20250509145646-a62d39695c06
	k8s.io/api v0.32.1
	...
	sigs.k8s.io/controller-runtime v0.20.0 // Since we are using the Istio library directly, we should also use the controller-runtime version that is used by Istio.
...
require (
	...
	github.com/envoyproxy/go-control-plane/contrib v1.32.4-0.20250114143102-4eb1955954fa // indirect
	github.com/envoyproxy/go-control-plane/envoy v1.32.4-0.20250114143102-4eb1955954fa // indirect
