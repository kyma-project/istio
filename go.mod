...
require (
	...
	sigs.k8s.io/controller-runtime v0.24.1 // Since we are using the Istio library directly, we should also use the controller-runtime version that is used by Istio.
...
require (
	...
	github.com/envoyproxy/go-control-plane/contrib v1.36.1-0.20260713214202-ca8ce173c36f // indirect
	github.com/envoyproxy/go-control-plane/envoy v1.37.1-0.20260713214202-ca8ce173c36f // indirect
