...
require (
	...
	sigs.k8s.io/controller-runtime v0.13.1 // Since we are using the Istio library directly, we should also use the controller-runtime version that is used by Istio.
