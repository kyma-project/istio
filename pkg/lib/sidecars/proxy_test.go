...
var _ = Describe("RestartProxies", func() {
	...
	It("should call restart proxies with respective predicates", func() {
		...
		Expect(podsListerMock.Predicates[0][4]).To(BeAssignableToTypeOf(&predicates.CniRestartPredicate{}))
		...
		Expect(podsListerMock.Predicates[1][4]).To(BeAssignableToTypeOf(&predicates.CniRestartPredicate{}))
