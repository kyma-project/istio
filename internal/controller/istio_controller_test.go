...
var _ = Describe("Istio Controller", func() {
	Context("Reconcile", func() {
		BeforeEach(func() {
			...
			_ = os.Setenv("ztunnel", "europe-docker.pkg.dev/kyma-project/prod/external/istio/ztunnel:1.26.2-distroless")
		})
		AfterEach(func() {
...
func (i *istioResourcesReconciliationMock) Reconcile(_ context.Context, _ operatorv1alpha2.Istio, _ *strategy.Hyperscaler) describederrors.DescribedError {
	return i.err
}
...
func (i *istioInstallationReconciliationMock) Reconcile(_ context.Context, _ *operatorv1alpha2.Istio, _ status.Status, _ images.Images, _ *strategy.Hyperscaler) (istiooperator.IstioImageVersion, describederrors.DescribedError) {
