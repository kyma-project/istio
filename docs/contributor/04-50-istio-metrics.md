...
| **istio_forward_client_cert_details_configured**       | Indicates whether **forwardClientCertDetails** is different then the default value of `SANITIZE` (`1` for configured, `0` for not configured). |
