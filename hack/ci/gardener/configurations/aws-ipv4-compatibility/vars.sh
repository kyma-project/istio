...
# ipv4 shoot. Auto-loaded by provision-gardener.sh / integration-test-gardener.sh
# when PRESET_NAME=aws-ipv4-compatibility. Same shoot as aws-ipv4, but pinned to
